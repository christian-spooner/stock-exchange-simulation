...
class Engine {
   public:
	Engine() {
		...
		channel = AmqpClient::Channel::CreateFromUri("amqp://guest:guest@127.0.0.1:5672/%2F");
		channel->DeclareExchange("financial_exchange", AmqpClient::Channel::EXCHANGE_TYPE_DIRECT,
								 true);
	}
