...
namespace MarketDataFeed
{
    ...
    {
        private static string MDconnectionString = "Host=localhost;Database=market_data;Username=guest;Password=guest";
        private static string CHconnectionString = "Host=localhost;Database=clearinghouse;Username=guest;Password=guest";
